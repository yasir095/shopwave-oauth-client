                ...
                httpRequestBuilder.multipartFileUpload(objHttpRequest, function (httpResponse) {
                    ...
                    if (httpResponse !== undefined && httpResponse !== null) {
                        ...
                        if (httpResponse.error == true) {
                            ...
                            Auth.prototype.validateToken.call(parentInstance, httpResponse, function (responseObject) {
                                if (responseObject.error === true) {
                                    /* Token is expired , request new token */
                                    req.body.grantType = "refresh_token"
                                    Auth.prototype.requestToken.call(parentInstance, req, function (tokenResponseObject) {
            ...
            else
            {
                ...
                httpRequestBuilder.makeCustomApiRequest(objHttpRequest, function (httpResponse) {
                    ...
                    if (httpResponse.error == true) {
                        ...
                        Auth.prototype.validateToken.call(parentInstace, httpResponse, function (responseObject) {

                            if (responseObject.error === true)
                            {
                                /* Token is expired , request new token */
                                req.body.grantType = "refresh_token"
                                Auth.prototype.requestToken.call(parentInstace, req, function (tokenResponseObject) {
